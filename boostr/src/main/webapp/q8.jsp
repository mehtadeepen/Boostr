...
<div class="container">
    <div class="col-md-8 col-md-offset-2 clearfix">
        ...
        Question 8 of 8
            ...
            <p class="text-justify text-center"> Would you rather ... ?
              </p>
...
<div id="slider">
    ...
    <br/>
    <form id="q8" name="q8" action="ArticlesView.jsp" method="post">
    ...
    <br>
    <input type="button" value="Next" class="btn-warning" onclick="setValues();"></input>
    </form>
     </div>
    </div>
</body>
