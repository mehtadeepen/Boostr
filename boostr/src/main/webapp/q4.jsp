...
<div class="container">
    <div class="col-md-8 col-md-offset-2 clearfix">
        ...
        Question 4 of 8
            ...
            <p class="text-justify text-center"> You're running late for your flight and
            need to get through security
             Do you ... ? </p>
       
<div id="slider">
    <div class="pull-right">
        <p> Wait and hope for the best </p>
    </div>
    <div class="pull-left">
        <p> Push your way to the front </p>
    </div>
    <br/>
    <div align="center">
    ...
    <br/>
    <form id="q4" name="q4" action="q5.jsp" method="post">
